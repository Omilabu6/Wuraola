...
function MenuItem({ link, text, image, onClick }) {
  ...
  return (
    <div className="flex-1 relative overflow-hidden text-center shadow-[0_-1px_0_0_#fff]" ref={itemRef}>
      ...
      <a className="flex items-center justify-center h-full relative cursor-pointer uppercase no-underline font-semibold text-white text-[4vh] hover:text-[#060010] focus:text-white focus-visible:text-[#060010]"
        href={link}
        onClick={(e) => {
          if (onClick) {
            onClick(e);
      ...
      <div
        className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none bg-indigo-300 translate-y-[101%]"
        ref={marqueeRef}
      >
